    ...
    <Provider store={store}>
      <Router>
        <div className="font-sans bg-white min-h-screen">
          <div
            className="bg-cover bg-no-repeat relative flex flex-col items-center justify-center text-white text-center"
            style={{
          ...
          >
            ...
            <div className="z-10 bg-green-600 text-green-100 font-medium text-lg rounded-lg shadow-lg px-4 py-3 w-1/4 cursor-pointer">
              Yuk Donasi
            </div>
          </div>
          ...
          <section className="flex flex-col items-center pt-4 bg-gray-50">
            ...
            <div className="grid grid-cols-5 grid-rows-1 w-full gap-4 p-4 mt-4">
          ...
          <section className="bg-white flex flex-col items-center py-4">
            ...
            <div className="grid grid-cols-2 grid-rows-1 mt-3 px-3 gap-4">
              <div className="">
                <img
              ...
              <p className="text-justify leading-8 px-3">
                <p className="font-semibold">Assalamu'alaikum</p>Saat ini, kita sedang dilanda wabah covid-19 (corona
                virus), keadaan ini sekejap merubah seluruh aktifitas masyarakat yang mengharuskan untuk bekerja dari
                rumah. Bekerja dari rumah hanya dapat dilakukan oleh sebagian orang, tidak berlaku untuk pedagang kecil,
                buruh harian, dan yang lainya. Mereka tetap berjuang untuk menafkahi keluarga di tengah wabah yang
                sedang terjadi. Pada kesempatan ini, kami ingin bergerak untuk membantu saudara kita yang sedang
                berjuang dijalan dengan memberikan <span className="font-semibold">Paket Sembako</span> yang insya Allah
                akan di distribusikan di setiap Jum'at, gerakan dan penggalangan donasi ini akan berlangsung sampai
                waktu yang tidak di tentukan, sedikit Rezeki yang kita beri akan memberikan banyak energi untuk mereka
                semua.
                <br />
                <p className="italic">
            ...
            <div className="grid grid-cols-2 grid-rows-1 mt-3 px-3 gap-40">
              ...
              <div className="flex items-center space-x-4">
                <svg
                  ...
                  viewBox="0 0 24 24"
                  class="icon-location-pin w-12 text-green-theme fill-current"
                >
                  <g>
                    <path
                      class="secondary"
          ...
          <section className="bg-green-theme flex py-4 flex-col items-center">
            ...
            <h5 className="text-lg leading-7 text-green-100">
          ...
          <section className="bg-white flex py-4 flex-col items-center">
            ...
            <div className="grid grid-cols-2 grid-rows-1 gap-4 mt-5 w-3/5">
              <div className="space-y-5 border-r-2 border-gray-200 pr-10">
            ...
            <div className="grid grid-cols-2 grid-rows-1 gap-4 mt-5 w-3/5 mt-10 ">
              <div className="px-4 py-2 bg-green-theme text-green-100 text-center shadow rounded-lg cursor-pointer flex items-center space-x-4">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="w-8 h-8 text-white fill-current">
                  <path
                    class="primary"
